...
class Post(database.Model):
    ...
    data_create = database.Column(database.DateTime, nullable=False, default=database.utcnow())
    id_user =  database.Collumn(database.Integer, database.ForeignKey('usuario.id', nullable=False))